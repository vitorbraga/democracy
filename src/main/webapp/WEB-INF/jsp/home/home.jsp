...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/resources/css/sweet-alert.css">
		...
		<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.html"><img
					src="${pageContext.request.contextPath}/resources/images/democracy_min.png" /></a>
			</div>
			<!-- Top Menu Items -->
			...
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				<ul class="nav navbar-nav side-nav">
					...
					<li><a href="javascript:;" data-toggle="collapse"
						data-target="#question"><i class="fa fa-fw fa-arrows-v"></i>
							Perguntas <i class="fa fa-fw fa-caret-down"></i></a>
						<ul id="question" class="collapse">
							<li><a href="#newQuestion" class="routeLink"
								callback="newQuestion">Nova Pergunta</a></li>
							<li><a href="#searchQuestion" class="routeLink">Buscar</a></li>
						</ul></li>
					<li><a href="javascript:;" data-toggle="collapse"
						data-target="#statistics"><i class="fa fa-fw fa-arrows-v"></i>
							Estatísticas <i class="fa fa-fw fa-caret-down"></i></a>
						<ul id="statistics" class="collapse">
							<li><a href="#" class="routeLink">Perguntas</a></li>
							<li><a href="#" class="routeLink">Usuários</a></li>
						</ul></li>
					<li><a href="javascript:;" data-toggle="collapse"
						data-target="#users"><i class="fa fa-fw fa-arrows-v"></i>
							Usuários <i class="fa fa-fw fa-caret-down"></i></a>
						<ul id="users" class="collapse">
							<li><a href="#searchUser" class="routeLink">Buscar</a></li>
							<li><a href="#newAdmin" class="routeLink">Cadastrar
									Admin</a></li>
						</ul></li>
				</ul>
			</div>
